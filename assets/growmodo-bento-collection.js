class GrowmodoBentoCollection extends HTMLElement {
  constructor() {
    super();
    this.swiper = null;
  ...
  connectedCallback() {
    this.swiperElement = this.querySelector('.growmodo-bento-collection__swiper');
...
if (!customElements.get('growmodo-bento-collection')) {
  customElements.define('growmodo-bento-collection', GrowmodoBentoCollection);
}
